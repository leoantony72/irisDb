...
type NodeState struct {
	...
	ResourceScore  float64 `protobuf:"fixed64,7,opt,name=resource_score,json=resourceScore,proto3" json:"resource_score,omitempty"`
...
func (x *NodeState) GetResourceScore() float64 {
	if x != nil {
...
const file_gossip_proto_rawDesc = "" +
	"\n" +
	"\fgossip.proto\x12\x04main\"\xeb\x01\n" +
	"\tNodeState\x12\x17\n" +
	...
	"\x0eresource_score\x18\a \x01(\x01R\rresourceScore\"\x8b\x01\n" +
	"\rGossipMessage\x124\n" +
